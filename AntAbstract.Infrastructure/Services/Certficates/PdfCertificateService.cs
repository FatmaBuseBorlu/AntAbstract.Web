...
{
    // Bu sınıf sadece PDF üretir. DB/mail/sertifika akışı burada yok.
            ...
            container.Page(page =>
            {
                ...
                page.Content().PaddingVertical(1, Unit.Centimetre).Column(col =>
                {
                    ...
                    col.Item().AlignCenter()
                        ...
                        .Bold().FontSize(26).LetterSpacing(2);
                    ...
                    col.Item().AlignCenter()
                        .Text($"\"{_model.SubmissionTitle}\"")
                        .FontSize(18).Italic().FontColor(Colors.Grey.Darken2);

                    col.Item().Text("Authored by:").FontSize(14);

                    var authors = (_model.Authors != null && _model.Authors.Count > 0)
                        ? string.Join("; ", _model.Authors)
                        : "-";
