...
namespace AntAbstract.Infrastructure.Migrations
{
    ...
    [Migration("20260624193816_ConferenceSlugRequiredAndExternalUrl")]
    partial class ConferenceSlugRequiredAndExternalUrl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AntAbstract.Domain.Entities.InvitedSpeaker", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AntAbstract.Domain.Entities.ReviewBid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AntAbstract.Domain.Entities.ScheduledBroadcast", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AntAbstract.Domain.Entities.Session", b =>
                {
                    ...
                    b.Property<string>("LiveStreamPlatform")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("AntAbstract.Domain.Entities.Sponsor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AntAbstract.Domain.Entities.Submission", b =>
                {
                    ...
                    b.Property<DateTime?>("RebuttalDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("AntAbstract.Domain.Entities.Message", b =>
                {
                    b.HasOne("AntAbstract.Domain.Entities.Message", "ParentMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("AntAbstract.Domain.Entities.ScheduledBroadcast", b =>
                {
                    ...
                    b.HasOne("AntAbstract.Domain.Entities.AppUser", "CreatedByUser")
                        .WithMany()
