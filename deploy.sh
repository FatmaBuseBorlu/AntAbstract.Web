...
echo "  3. Eski .exe ve .dll dosyalarını sil"
echo "     ⚠️  appsettings.Production.json'a DOKUNMA — bağlantı dizesi orada."
echo "         Silinirse site 500 verir; pakette olmadığı için geri gelmez."
echo "     (logs/ private-uploads/ wwwroot/uploads/ da dokunma!)"
echo "  4. ZIP'i yükle → Sağ tık → Arşivi Aç → üzerine yaz seç"
echo "  5. ZIP'i sil"
echo "  6. Plesk → .NET → Restart App"
echo "  7. migration.sql varsa Plesk MSSQL aracında çalıştır"
echo "─────────────────────────────────────────────────────────────────────"
echo ""
